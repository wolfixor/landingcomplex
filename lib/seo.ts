...
export const structuredData = {
  organization: {
    ...
    logo: "https://psycho.tomakdigitalagency.ir//logo.png",
  ...
  website: {
    ...
    potentialAction: {
      "@type": "SearchAction",
      target: "https://psycho.tomakdigitalagency.ir//search?q={search_term_string}",
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "خانه",
        item: "https://psycho.tomakdigitalagency.ir/",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "ویژگی‌ها",
        item: "https://psycho.tomakdigitalagency.ir/#features",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "قیمت‌گذاری",
        item: "https://psycho.tomakdigitalagency.ir/#pricing",
      },
    ],
  },
    ...
    offers: [
      {
        ...
        url: "https://psycho.tomakdigitalagency.ir/#pricing",
      },
      {
        "@type": "Offer",
        name: "پلن حرفه‌ای",

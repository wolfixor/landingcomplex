...
export const structuredData = {
  organization: {
    ...
    logo: "https://dashboard.musictomak.shop//logo.png",
  ...
  website: {
    ...
    potentialAction: {
      "@type": "SearchAction",
      target: "https://dashboard.musictomak.shop//search?q={search_term_string}",
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "خانه",
        item: "https://dashboard.musictomak.shop/",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "ویژگی‌ها",
        item: "https://dashboard.musictomak.shop/#features",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "قیمت‌گذاری",
        item: "https://dashboard.musictomak.shop/#pricing",
      },
    ],
  },
    ...
    offers: [
      {
        ...
        url: "https://dashboard.musictomak.shop/#pricing",
      },
      {
        "@type": "Offer",
        name: "پلن حرفه‌ای",
